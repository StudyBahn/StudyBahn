...
*/
#define DS1307_I2C_ADR 0xD0 // or in Binary = 0b1101000 is the Address of the DS1307 (Slave Address)
...
uint8_t ds1307_getTime(void){
	...
	// Read value
	second = ds1307_decodeBcd(i2c_master_read_next() & 0x7F); // Mask out CH bit
	// TODO minute, hour, ...
